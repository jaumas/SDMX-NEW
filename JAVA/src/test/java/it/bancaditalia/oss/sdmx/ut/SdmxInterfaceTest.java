...
public class SdmxInterfaceTest
{
	...
	{
		SdmxClientHandler.addProvider("TESTv2", "http://data-api.ecb.europa.eu/service", NONE, false, false, false, "test provider", V2);
		GenericSDMXClient a = SDMXClientFactory.createClient("TESTv2");
		assertNotNull("Add Provider v2 failed", a);
		SdmxClientHandler.addProvider("TESTv3", "http://data-api.ecb.europa.eu/service", NONE, false, false, false, "test provider", V3);
